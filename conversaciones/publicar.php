...
<table width="900" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <div style="border:#999 1px solid; width:970px; margin:0 auto 0 auto; padding:15px; background-color:#F4F9E8; <? echo $display_conversacion ?>">
    ...
    Crea una conversación para interactuar con la comunidad Hispamercado sobre cualquier tema de tu interés. <strong>Haz una pregunta o comparte una idea</strong>. Una conversación tambien puede ser una forma de incrementar las visitas a tus anuncios, desde cada conversación se enlazaran a los anuncios relacionados con la tematica de la conversaci&oacute;n.   
    </em></div>
    ...
    <input name="notificaciones" type="checkbox" id="notificaciones" value="SI" checked <? echo $pre_notif ?>>
