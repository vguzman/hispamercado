...
<body>
<form name="FormaFoto" method="post" action="tiendaSubirLogo2.php" enctype="multipart/form-data">
  ...
  <table width="300" border="0" align="center" cellpadding="0" cellspacing="6">
    ...
    <table width="300" border="0" align="center" cellpadding="0" cellspacing="6">
      <tr>
        <td><input type="button" name="Submit2" value="Aceptar" onClick="cargando(this)"></td>
      </tr>
    </table>
</form>
</body>
