  ...
  <tr>
    <?
			...
			if ($_GET['id_cat']!="")
			{
			 ...
			 {
				 echo "<td width='300' align='left' valign='top' class='arial12Negro'>Categorías:<br>";
				 for ($i=0;$i<count($anuncios);$i++)
				 {
			...
			{				
				...
				{			
					...
					echo "<br><table width='100%' border='0' cellpadding='0' cellspacing='0'>
							  <tr>
								<td align='left' valign='bottom' class='arial12Gris'><strong>Año: ".$_GET['anio']." <a href='".$url."'><img src='img/Windows-Close-Program-16x16.png' width='13' height='13' alt='Eliminar filtro' border='0'></a></strong></td>
								</tr>
							</table>";
				}
				else
				{
					echo "<br><span id='listadoAnios_html'>Año:</span><br>";
