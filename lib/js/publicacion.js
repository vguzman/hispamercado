...
{	
	...
	req.open("GET","ajax_detallesAnuncio.php?id_cat="+id_cat+"&id_anuncio="+id_anuncio,true);
	req.send(null);	
} 
...
{	
	...
	req.open("GET","ajax_modelos.php?marca="+e.value,true);
	req.send(null);
} 
...
function calibrarFotos()
{
	...
	var url="ajax_calibrarFotos.php?foto1="+document.Forma['aux1'].value+"&foto2="+document.Forma['aux2'].value+"&foto3="+document.Forma['aux3'].value+"&foto4="+document.Forma['aux4'].value+"&foto5="+document.Forma['aux5'].value+"&foto6="+document.Forma['aux6'].value+"&code="+document.Forma['id_anuncio'].value;
