...
function validarRecomendacion()
{
	...
	{
		document.Forma_Contacto.button.disabled=false;
		document.Forma_Contacto.button.value="Enviar recomendacion";
	}
}
	...
	function nuevoComentario()
	{
		if (req.readyState==4)
		{
			...
			{		
				...
				var puntos=substr_count(req.responseText,"puntos",0,10);
				
				//window.alert(puntos+" puntos");
				if (puntos>0) callFaceboxPuntos('../puntosGanados.php?puntos=2&tipo=comentario');	
			} 
			else
